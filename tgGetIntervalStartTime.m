function t = tgGetIntervalStartTime(tg, tierInd, index)
% function t = tgGetIntervalStartTime(tg, tierInd, index)
% Vrátí èas zaèátku intervalu s daným indexem ve vybrané vrstvì (tier) typu IntervalTier.
